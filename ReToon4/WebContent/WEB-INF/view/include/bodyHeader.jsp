...
<div id="divHeaderWrapper">
    ...
    <div class="navbar navbar-wp navbar-arrow mega-nav" role="navigation">
        <div class="navbar-header">
            ...
            </a><div style="padding-left:15px; width:200px">http://www.ReToon.co.kr</div>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href='<c:url value="/"/>' class="dropdown-toggle"><fmt:message key="HOME"/></a>
                    <!-- ul class="dropdown-menu">
                        <li><a href='<c:url value="/"/>'><fmt:message key="menu_dashboard"/></a></li>
                    </ul-->
                </li>
                <li class="dropdown">
                    <a href='<c:url value="/ratingslist.do"/>' class="dropdown-toggle"><fmt:message key="RATINGS"/></a>
                    <!-- ul class="dropdown-menu">
                        <li><a href='<c:url value="/"/>'><fmt:message key="menu_dashboard"/></a></li>
                    </ul-->
                </li>
                <li class="dropdown">
                    <a href='<c:url value="/toonlist.do"/>' class="dropdown-toggle"><fmt:message key="RECOMMEND"/></a>
                    <!-- ul class="dropdown-menu">
                        <li><a href='<c:url value="/"/>'><fmt:message key="menu_dashboard"/></a></li>
                    </ul-->
                </li>
